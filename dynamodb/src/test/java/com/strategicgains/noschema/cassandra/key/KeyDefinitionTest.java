...
import com.strategicgains.noschema.dynamodb.key.SortKeyComponent;
import com.strategicgains.noschema.dynamodb.key.DataTypes;
import com.strategicgains.noschema.dynamodb.key.KeyComponent;
...
import com.strategicgains.noschema.dynamodb.key.SortKeyComponent.Ordering;
...
public class KeyDefinitionTest
{
	...
	public void shouldHandleComplex()
	{
		...
		kd.addPartitionKey(new KeyComponent("alpha", DataTypes.UUID))
			.addPartitionKey(new KeyComponent("beta", DataTypes.TEXT))
			.addClusteringKey(new SortKeyComponent("chi", DataTypes.TIMESTAMP, Ordering.DESC))
			.addClusteringKey(new SortKeyComponent("delta", DataTypes.INTEGER, Ordering.ASC));
	...
	public void shouldHandleComplexWithDefaultSort()
	{
		...
		kd.addPartitionKey(new KeyComponent("alpha", DataTypes.UUID))
			.addPartitionKey(new KeyComponent("beta", DataTypes.TEXT))
			.addClusteringKey(new SortKeyComponent("chi", DataTypes.TIMESTAMP, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("delta", DataTypes.INTEGER, Ordering.ASC));
		assertEquals("alpha uuid,beta text,chi timestamp,delta int", kd.asColumns());
		assertEquals("primary key ((alpha,beta),chi,delta)", kd.asPrimaryKey());
		assertTrue(kd.isValid());
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("account_id", "account.id", DataTypes.TEXT))
			...
			.addClusteringKey(new SortKeyComponent("height", DataTypes.TEXT, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("createdAt", DataTypes.DECIMAL, Ordering.ASC));
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("account_id", "account.id", DataTypes.TEXT))
			...
			.addClusteringKey(new SortKeyComponent("height", DataTypes.FLOAT, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("createdAt", DataTypes.TIMESTAMP, Ordering.ASC));
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("name", DataTypes.TEXT))
			.addClusteringKey(new SortKeyComponent("height", DataTypes.DECIMAL, Ordering.ASC));
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("name", DataTypes.TEXT))
			...
			.addClusteringKey(new SortKeyComponent("updatedAt", DataTypes.TIMESTAMP, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("not_there", DataTypes.DECIMAL, Ordering.ASC));
		kd.identifier(new Flower());
	}
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("not_there", DataTypes.TEXT))
			...
			.addClusteringKey(new SortKeyComponent("chi", DataTypes.TEXT, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("delta", DataTypes.DECIMAL, Ordering.ASC));
	...
	throws KeyDefinitionException, InvalidIdentifierException
	{
		...
		kd.addPartitionKey(new KeyComponent("not_there", DataTypes.TEXT))
			...
			.addClusteringKey(new SortKeyComponent("name", DataTypes.TEXT, Ordering.ASC))
			.addClusteringKey(new SortKeyComponent("height", DataTypes.DECIMAL, Ordering.ASC));
