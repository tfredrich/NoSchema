...
implements RepositoryObserver<T>, DocumentObserver<T>
{
    /**
     ...
     */
    @Override
    public void afterRead(T document) {}
     ...
     */
    @Override
    public void beforeCreate(T document) {}
     ...
     */
    @Override
    public void afterCreate(T document) {}
     ...
     */
    @Override
    public void beforeDelete(T document) {}
     ...
     */
    @Override
    public void afterDelete(T document) {}
     ...
     */
    @Override
    public void beforeUpdate(T document) {}
     ...
     */
    @Override
    public void afterUpdate(T document) {}
