...
public abstract class AbstractCassandraNoSchemaRepository<T extends Identifiable>
implements CassandraNoSchemaRepository<T>
{
	...
	protected AbstractCassandraNoSchemaRepository(CqlSession session, PrimaryTable table)
	{
		super();
	...
	protected T create(T entity, DocumentUnitOfWork unitOfWork)
	{
		DocumentUnitOfWork uow = (unitOfWork != null ? unitOfWork : createUnitOfWork());
	...
	protected boolean delete(Identifier id, DocumentUnitOfWork unitOfWork)
	{
		try
		{
			DocumentUnitOfWork uow = (unitOfWork != null ? unitOfWork : createUnitOfWork());
	...
	protected T update(T entity, DocumentUnitOfWork unitOfWork)
	{
		try
		{
			DocumentUnitOfWork uow = (unitOfWork != null ? unitOfWork : createUnitOfWork());
	...
	protected T upsert(T entity, DocumentUnitOfWork unitOfWork)
	{
		DocumentUnitOfWork uow = (unitOfWork != null ? unitOfWork : createUnitOfWork());
	...
	{
		return new DocumentUnitOfWork(session, statementGenerator);
	}
