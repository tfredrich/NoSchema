...
public final class IndexStatementFactory<T>
implements CqlStatementFactory<T>
{
	...
	private CassandraIndexDocumentFactory<T> documentFactory;
	...
	{
		this(session, table, new CassandraIndexDocumentFactory<>(table.keys(), codec));
	}

	public IndexStatementFactory(CqlSession session, AbstractTable table, CassandraIndexDocumentFactory<T> factory)
	{
		super();
